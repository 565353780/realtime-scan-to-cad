...
{
	const float cosAlpha = cos(angles.z); float cosBeta = cos(angles.y); float cosGamma = cos(angles.x);
	const float sinAlpha = sin(angles.z); float sinBeta = sin(angles.y); float sinGamma = sin(angles.x);
...
{
	return evalRMat_dAlpha(cos(angles.z), cos(angles.y), cos(angles.x), sin(angles.z), sin(angles.y), sin(angles.x));
}
...
{
	return evalRMat_dBeta(cos(angles.z), cos(angles.y), cos(angles.x), sin(angles.z), sin(angles.y), sin(angles.x));
}
...
{
	return evalRMat_dGamma(cos(angles.z), cos(angles.y), cos(angles.x), sin(angles.z), sin(angles.y), sin(angles.x));
}
